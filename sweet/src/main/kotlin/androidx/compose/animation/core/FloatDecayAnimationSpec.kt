...
// Sweet adaptation: removed @FloatRange annotation (not available),
// removed createAnimation() extension (depends on unported Animation.kt).
...
public class FloatExponentialDecaySpec(
    // Sweet: removed @FloatRange(from = 0.0, fromInclusive = false)
    ...
    override fun getVelocityFromNanos(
        ...
        return (initialVelocity * exp(friction * playTimeNanos.toFloat() / 1_000_000_000f))
    }
