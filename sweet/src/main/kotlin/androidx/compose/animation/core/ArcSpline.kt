...
// Sweet: Replaced binarySearch import with local implementation,
// replaced fastCoerceIn with coerceIn, removed @JvmField annotations.
...
// Sweet: Local binarySearch for FloatArray (from internal/Arrays.kt)
private fun FloatArray.binarySearch(
    element: Float,
    fromIndex: Int = 0,
    toIndex: Int = size,
): Int {
